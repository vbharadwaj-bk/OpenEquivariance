...
class MultiplicityOuterProductTensorProduct(TensorProduct):
    def __init__(self, L1, L2, L3, batch_size):
        ...
        self.internal = MultiplicityOuterProductTensorProductImpl(L1, L2, L3, self.coord[0], self.coord[1], self.coord[2], self.values)
